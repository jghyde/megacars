...
$save_json_file = 'chevysuvs.json';
$image_dir = 'images/chevysuvs';
$url_to_fetch = 'http://www.megacars.com/VehicleSearchResults?bodyType=SUV&model=Trax&model=Acadia&model=Tahoe&model=Equinox&model=Terrain&model=Suburban&sort=year|asc&search=preowned&paymentTerm=monthly&make=GMC&make=Chevrolet';
