...
<h4>Bugs Monitor</h4>
ClickMeter monitorize application error and send email to our dev center by default. If you want to deactivate the Bugs Monitor system go in Plugin’s Settings > Authorize bugs monitor: and select “No”.
...
= 1.2.5.7 =
<ul>
<li>Interface BugFix</li>
</ul>

= 1.2.5.6 =
<ul>
<li>BugFix: the plugin was breaking some other plugin settings in wp admin panel</li>
</ul>

= 1.2.5.5 =
<ul>
<li>BugFix: the new plugin was not working with older php versions</li>
</ul>

= 1.2.5.4 =
<ul>
<li>Tracking links creation in batch mode</li>
...
= 1.2.5.3 =
<ul>
<li>Fixed the bug on replacing all current links in a post (or page) with tracking links</li>
<li>Better language encoding</li>
<li>Minor bug fixes</li>
</ul>

= 1.2.5.2 =
<ul>
<li>send error email to our dev center by default</li>
</ul>

= 1.2.5.1 =
<ul>
<li>BugFix: error on removing API-KEY for some installations</li>
<li>BugFix: error on creating post without title for some installations</li>
</ul>
